...
*   **O-Ring Standard**: AS568-152 (Nitrile NBR, 70 Durometer).
    *   *Cross Section (d_2)*: 2.62 mm
    *   *Inner Diameter (ID)*: 82.22 mm
*   **Gland Machining Specifications**:
    *   *Radial Gland Depth*: 2.02 mm (achieves 23\% radial compression).
    *   *Groove Width*: 3.60 mm (provides 20\% volumetric clearance for O-ring expansion under hydrostatic pressure).
    *   *Lead-in Chamfer*: 15° angle with a 1.5 mm length to prevent O-ring shearing during assembly.
...
*   **Maximum Torque Capacity (T_max)**: Designed for **1.8 N * m**.
...
*   **Axial Pull Force (F_axial)**: Calculated at **120 N (27 lbs)** at a 2.5 mm air gap.
*   **Thrust Washer**: To prevent the external hub from grinding against the Delrin cap, a **silicon nitride (Si_3N_4) ceramic thrust ball bearing** or a **glass-filled PTFE thrust washer** is positioned between the external hub and the cap face. This absorbs the continuous axial load with a low friction coefficient (\mu <= 0.04).
...
P_eddy  proportional to  (B² f² d²) / (\rho)
*   **Material Selection**: The barrier cap must be machined from **Unfilled PEEK** or **Delrin (POM-C)**. These polymers are non-conductive, eliminating eddy current losses (0 W loss) and preventing thermal degradation of the neodymium magnets (which begin permanent demagnetization at 80°C).
...
2.  **Barrier Cap Machining**: Lathe-machine the Delrin end cap. Turn down the front face where the magnets overlap to a wall thickness of exactly 1.5 mm. Machine the radial O-ring grooves to a depth of 2.02 mm.
...
4.  **Dry Assembly**: Install the motor in the PVC chamber. Push the Delrin cap into the chamber until it is flush, checking that the air gap between the internal magnets and the cap face is exactly 0.5 mm.
...
3.  **Shaft Installation**: Slide the 6mm stainless steel shaft through the polymer bearings, slide the ceramic thrust washer on, and secure the external magnet hub to the shaft.
4.  **Pressure Testing**: Assemble the dry chamber. Submerge the sealed pod in a pressure chamber filled with water. Pressurize to 1.5 bar (simulating a 15m depth) and hold for 2 hours. Open the chamber and verify that the interior remains completely dry.
...
| **N52 Block Magnets** | 24 | N52 Neodymium (10mm  x  10mm  x  3mm) | \$24.00 |
| **Delrin Stock (POM-C)** | 1 | 100mm diameter, 150mm length | \$35.00 |
| **SDR-35 PVC Pipe** | 1 | 3-inch nominal diameter (2ft) | \$12.00 |
| **Igus xiros Bearings** | 2 | Polymer ball bearings (6mm  x  15mm  x  5mm) | \$18.00 |
| **Ceramic Thrust Bearing** | 1 | Si3N4 Ceramic (6mm  x  14mm  x  5mm) | \$15.00 |
| **NBR-70 O-Rings** | 4 | AS568-152 Nitrile O-rings | \$4.00 |
| **Stainless Steel Shaft** | 1 | 316 Ground Shafting (6mm  x  100mm) | \$8.00 |
