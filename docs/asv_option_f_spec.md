...
*   **Solar Deck Size**: 1.4m width  x  2.0m length (2.8 m²) made of 4mm white Coroplast sheets secured to 2020 aluminum rails. The deck overhangs the frame by 200mm on both sides.
*   **Total Dry Mass**: ~ 96.5 kg (Payload: 85 kg + Hulls/Frame: 11.5 kg).
*   **Hydrodynamic Draft**: **~ 50–53\%** under full 96.5 kg load (waterline at the vertical center of the hulls). 
    *   *Justification*: By moving the 35 kg battery vault to the deck and spacing the hulls apart, the boat floats at its hydrodynamic sweet spot. This keeps the overhanging solar deck clean of splashes, minimizes wave-making resistance, and avoids solar cell shading.

### 1.2 Self-Righting & Stability Physics
*   **Center of Buoyancy (B)**: Located near the centerline at the waterline (z ~ -84mm).
*   **Center of Gravity (G)**: Located at z ~ -180mm. By hanging a 15 kg lead bulb at z = -450mm, the Center of Gravity is pulled well below the Center of Buoyancy despite the battery bank being mounted on the deck.
*   **Auto-Recovery Righting Moment**: If rolled past 90° or completely capsized (180°), the 15 kg lead ballast creates a powerful self-righting torque (Righting Arm GZ ~ 270mm). The buoyancy of the closed, empty PVC hulls pushes upward while the lead weight pulls downward, immediately self-righting the vessel. The overhanging Coroplast deck is designed with a slight camber (curved arch) to prevent water pooling and ensure it sheds water instantly during recovery.
...
*   **Battery Relocation**: The 48V  115Ah LiFePO4 battery bank (35 kg) is housed in a heavy-duty, IP67-rated polycarbonate enclosure mounted securely on the **aft-left deck**, directly over the structural aluminum frame.
...
*   **Solar Array**: Eight 100W flexible monocrystalline solar panels (540mm  x  1050mm) arranged in a 4x2 grid on the flat Coroplast deck.
*   **Redundant Dual MPPT**: The array is split into two independent 400W charging circuits:
...
*   **Dual Transom-Mounted Thrusters**: Two BlueRobotics T200 brushless underwater thrusters mounted directly to the stern transoms of the left and right PVC pontoons (spaced exactly 800mm apart).
...
*   **Rudderless Differential Steering**: Directional control is achieved entirely by varying the thrust difference between the left and right motors:
    omega  proportional to  (T_right - T_left)  *  0.8m
*   **Redundancy Analysis**: 
...
*   **System Power Consumption**: Draws ~ 6.0 W in Transit Mode (Pi 4 + Pixhawk + Comms active) and peaks at ~ 20.5 W in Avoidance Mode (Jetson + D455 fully active).
...
1.  **Hull Preparation**: Cut the two 6-inch SDR-35 PVC pipes to 2.53m. Use PVC primer and cement to secure standard PVC end-caps to the stern transoms. Cement the 3D-printed ASA wave-piercing bow caps to the front of each hull.
2.  **Keel Foil Installation**: Bolt the machined 8mm aluminum foil keel spar to the centerline of the aluminum frame using the 3D-printed root collar. Bolt the 15 kg lead ballast bulb to the bottom of the spar, securing it with locknuts and wrapping it in a thin layer of epoxy fiberglass to prevent galvanic corrosion.
3.  **Frame & Bracket Assembly**: Assemble the 2020 aluminum crossbeams (1.2m width) and long rails (1.9m length). Clamp the frame to the PVC pontoons at 800mm spacing using the custom single-hull mounting brackets cushioned with rubber friction strips.
...
7.  **Mast and Camera Setup**: Bolt the 1.2m vertical mast socket to the front center of the aluminum frame. Mount the Intel RealSense D455 in a waterproof dome on the bow or mast. Run the shielded USB 3.0 cable back to the Jetson Orin Nano inside the control box. Mount the dual F9P RTK GPS antennas spaced along the frame, and run their coax cables to the Pixhawk 6X. Route the LoRa, 5G, and Satellite antennas up the carbon fiber mast and connect them to the control box bulkheads.
