...
*   **Attachment**: Clamps to the bottom of the 8mm 6061-T6 aluminum foil spar. It is secured using two M5  x  25mm 316 stainless steel shoulder bolts passing through pre-drilled holes in the foil spar.
...
To prevent sand and micro-algae from entering the 0.8 mm gap between the stator and rotor, the assembly incorporates a **labyrinth seal**:
...
*   **Clearance**: A radial and axial gap of exactly 0.15 mm.
...
*   **Phase Leads**: Three 16 AWG extra-flexible silicone-insulated copper wires.
*   **Conduit**: The wires exit the rear of the stator potting, run inside a protective polyurethane sleeve, and route upwards through a 5mm slot machined along the trailing edge of the aluminum foil spar to the deck electronics box.
...
| **Motor Current Max**| 15.0 A | Limits peak current and thermal stress |
| **Absolute Max Current**| 25.0 A | Peak cutoff limit |
| **Motor Resistance (R)**| ~ 0.182 \Omega | Measured during motor detection |
| **Motor Inductance (L)**| ~ 145.2 \muH | Measured during motor detection |
| **Motor Flux Linkage** | ~ 0.0092 Wb | Measured during motor detection |
| **Switching Frequency**| 25.0 kHz | Minimizes acoustic noise and ripple |
| **Startup Boost** | 0.08 V | Initial voltage offset to break static inertia |
| **Observer Gain** | 1.50 | Increased by 50\% to stabilize rotor tracking in water |
| **Minimum ERPM** | 150 ERPM | Prevents commutation loss at low speeds |

### 2.3 Thermal Dissipation Modeling
Running a motor submerged in water offers exceptional cooling performance. The convective heat transfer coefficient of water (h_water) is:
h_water ~ 1,500 W/(m² * K)

The stator heat (P_loss) is conducted through the 0.8 mm potting layer of MG Chemicals 832TC epoxy (thermal conductivity k = 1.44 W/(m * K)):
R_thermal = (t) / (k  *  A_stator) ~ 0.05 K/W

At a continuous cruising power of 50W (with ~ 10W of electrical copper losses):
\Delta T_stator = P_loss  *  R_thermal ~ 10 W  *  0.05 K/W ~ 0.5°C
...
4.  **Vacuum Degassing**: Place the mixed epoxy in a vacuum chamber. Pull a vacuum of -29 in Hg and hold for 10 minutes. The epoxy will rise and collapse as air bubbles escape.
5.  **Pouring & Curing**: Pour the degassed epoxy into the mold slowly from one side to prevent air pockets. Cure in a dry oven at 65°C for 4 hours (or at room temperature for 24 hours).
...
1.  Use **full ZrO_2 (Zirconium Dioxide) open bearings** (8mm  x  16mm  x  5mm).
...
2.  Wrap the outer surface of the magnets with 0.2mm carbon-fiber prepreg tape, tensioning it tightly.
3.  Cure the wrap at 80°C to shrink and bond the carbon fiber, forming a permanent hoop-stress sleeve that prevents magnets from delaminating or corroding.
...
| **Full Ceramic Bearings** | 2 | ZrO2 Open (8mm  x  16mm  x  5mm) | \$32.00 |
| **Carbon Fiber Prepreg Tape**| 1 | 10mm width, 1m length | \$12.00 |
| **3D Printing Filament** | 1 | ASA filament (1 kg) | \$35.00 |
| **Stainless Steel Shaft** | 1 | 316 Ground Shafting (8mm  x  120mm) | \$10.00 |
| **Folding Propeller Hub** | 1 | Carbon Fiber folding prop assembly | \$25.00 |
| **Zinc Anode Collar** | 1 | 50 g shaft anode (8mm ID) | \$8.00 |
